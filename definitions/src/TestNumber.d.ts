...
export declare class TestNumber {
    ...
    static notEquals(failMessage: string, val: number, expected: number): void;
    ...
    static null(failMessage: string, val: number): void;
    static undefined(failMessage: string, val: number): void;
}
